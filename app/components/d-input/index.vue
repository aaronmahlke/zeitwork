...
<template>
  <div
    class="bg-neutral border-neutral text-neutral text-copy has-[:focus]:bg-neutral flex h-8 overflow-hidden rounded-md border leading-none transition-all outline-none has-[:focus]:border-neutral-300 has-[:focus]:ring-2 has-[:focus]:ring-neutral-200"
    :class="[
      disabled
